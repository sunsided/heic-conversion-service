#[cfg(test)]
mod tests {
    use libheif_rs::{Channel, RgbChroma, ColorSpace, HeifContext, Result, ItemId, EncoderQuality, Image, CompressionFormat};
    use tempfile::NamedTempFile;

    #[test]
    pub fn read_heif() -> Result<()> {
        // This test method was copied from libheif_rs and is meant to
        // familiarize contributors of this project with the usage of libheif_rs itself.
    ...
    pub fn write_heif() -> Result<()> {
        ...
        context.write_to_file(tmp_file.path().to_str().expect("bang").as_ref())?;
